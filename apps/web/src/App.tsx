                ...
                : React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(Route, { path: '/artist/:id', element: React.createElement(ArtistPage) }),
                       ...
                       React.createElement(Route, { path: '/genre/:id', element: React.createElement(GenrePage) }),
                       React.createElement(Route, { path: '/collection/:id', element: React.createElement(CollectionPage) }),
