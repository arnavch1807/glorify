...
export function Notifications() {
  ...
  return React.createElement(
    'div',
    { className: 'flex flex-col gap-ch-6 w-full text-glorify-text-primary' },
    
    // Header Panel
    React.createElement(
      'div',
      { className: 'flex items-center justify-between border-b border-glorify-border-primary/10 pb-ch-4' },
      React.createElement(
        'div',
        { className: 'flex items-center gap-ch-3' },
        React.createElement(Bell, { className: 'w-ch-6 h-ch-6 text-glorify-accent' }),
        React.createElement(
          'div',
          ...
          React.createElement(
            'span',
            { className: 'text-xs text-glorify-text-secondary mt-0.5' },
    ...
    isLoading
      ? React.createElement(
          ...
          React.createElement('div', { className: 'w-ch-8 h-ch-8 border-2 border-glorify-accent border-t-transparent rounded-full animate-spin' })
        )
      : notifications.length === 0
      ? React.createElement(
          'div',
          { className: 'flex flex-col items-center justify-center text-center py-16 gap-ch-4 bg-glorify-bg-surface/20 border border-glorify-border-primary/5 rounded-[22px] p-8' },
          React.createElement(Bell, { className: 'w-12 h-12 text-glorify-text-muted/40 stroke-[1.5]' }),
          React.createElement(
            'div',
            { className: 'flex flex-col gap-1' },
            React.createElement('h2', { className: 'text-base font-semibold text-glorify-text-secondary' }, 'No notifications yet'),
            React.createElement('p', { className: 'text-xs text-glorify-text-muted max-w-xs' }, 'We will notify you here when you compose AI tracks, download songs offline, or verify credentials.')
          )
        )
      : React.createElement(
          'div',
          ...
          notifications.map(n =>
            React.createElement(
              'div',
              {
                ...
                className: `p-ch-4 rounded-ch-xl border transition-all duration-300 flex items-start gap-ch-4 relative overflow-hidden group ${
                  !n.read 
              ...
              React.createElement(
                'div',
                { className: 'flex-1 flex flex-col gap-1 min-w-0 pr-ch-6' },
                React.createElement(
                  'span',
                  { className: `text-sm font-semibold truncate ${!n.read ? 'text-glorify-text-primary' : 'text-glorify-text-secondary'}` },
                  n.title
                ),
                React.createElement(
                  'span',
                ...
                React.createElement(
                  'div',
                  { className: 'flex items-center gap-ch-1.5 text-[10px] text-glorify-text-muted mt-1 font-medium' },
                  React.createElement(Calendar, { className: 'w-ch-3 h-ch-3' }),
                  React.createElement('span', null, new Date(n.createdAt).toLocaleDateString(undefined, {
                    month: 'short',
                    day: 'numeric',
                    hour: '2-digit',
                    minute: '2-digit',
