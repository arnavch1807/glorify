...
export function PlaylistPage() {
  ...
  if (!playlist) {
    return React.createElement(
      ...
      React.createElement('h2', { className: 'text-xl font-bold' }, 'Playlist Not Found'),
      React.createElement(
        'button',
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'w-40 h-40 sm:w-48 sm:h-48 rounded-[24px] overflow-hidden bg-glorify-bg-secondary border border-glorify-border-primary flex items-center justify-center shadow-2xl flex-shrink-0 relative group' },
        playlist.coverImage
          ...
          : React.createElement(Music, { className: 'w-16 h-16 text-glorify-text-muted' }),
        React.createElement(
          'button',
          {
          ...
          React.createElement(Edit, { className: 'w-ch-4 h-ch-4' }),
          'Change Cover'
        )
      ),
      ...
      React.createElement(
        ...
        React.createElement('span', { className: 'text-[10px] font-bold text-glorify-accent tracking-widest uppercase' }, 'PLAYLIST'),
        ...
        isEditingDesc
          ? React.createElement(
              'div',
              { className: 'flex items-center gap-2 max-w-xl mt-1' },
              React.createElement('input', {
                type: 'text',
                value: editDesc,
          ...
          : React.createElement(
              ...
              playlist.description || 'No description loaded. Double click to add details.',
              React.createElement(
                'button',
                {
        ...
        React.createElement(
          'div',
          { className: 'flex flex-wrap items-center justify-center md:justify-start gap-ch-2 text-xs text-glorify-text-muted font-medium mt-2' },
          React.createElement('span', { className: 'text-glorify-text-primary font-semibold' }, 'Creator: ' + (playlist.userId === 'user_dev' ? 'You' : 'Glorify AI')),
          React.createElement('span', null, '•'),
          React.createElement('span', null, `${mockFollowers.toLocaleString()} followers`),
          React.createElement('span', null, '•'),
          React.createElement('span', null, `${tracks.length} song${tracks.length === 1 ? '' : 's'}`),
          tracks.length > 0 && React.createElement('span', null, '•'),
          tracks.length > 0 && React.createElement('span', { className: 'flex items-center gap-1' }, React.createElement(Clock, { className: 'w-ch-3.5 h-ch-3.5' }), formatTotalTime(totalDuration))
        )
      )
    ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        tracks.length > 0 &&
          React.createElement(
            ...
            React.createElement(Play, { className: 'w-ch-4 fill-currentColor pl-0.5' }),
            'Play All'
          ),
        tracks.length > 0 &&
          React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Copy, { className: 'w-ch-4 h-ch-4' }),
          'Duplicate'
        ),
        React.createElement(
          motion.button,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        tracks.length === 0
          ? React.createElement(
              'div',
              { className: 'text-center py-20 flex flex-col items-center justify-center gap-ch-4 font-sans select-none' },
              React.createElement(Music, { className: 'w-12 h-12 text-glorify-text-muted/40 animate-pulse' }),
              React.createElement(
                'div',
                { className: 'flex flex-col gap-1' },
                React.createElement('span', { className: 'text-sm font-semibold text-glorify-text-secondary' }, 'Nothing here yet.'),
                React.createElement('span', { className: 'text-xs text-glorify-text-muted' }, "Let's build your music world.")
              ),
              React.createElement(
                'button',
                {
