...
export function Login() {
    ...
    React.createElement('div', { className: 'flex flex-col gap-1.5' }, React.createElement('div', { className: 'flex justify-between items-center px-1' }, React.createElement('label', { className: 'text-xs font-bold text-glorify-text-secondary' }, 'Password'), React.createElement(Link, { to: '/forgot-password', className: 'text-[11px] text-glorify-accent hover:underline outline-none focus-ring font-medium' }, 'Forgot Password?')), React.createElement('div', { className: 'relative flex items-center' }, React.createElement(Lock, { className: 'absolute left-4 w-4 h-4 text-glorify-text-muted' }), React.createElement('input', {
        type: 'password',
        required: true,
        value: password,
    ...
    }, loading ? 'Authenticating...' : 'Sign In', !loading && React.createElement(Sparkles, { className: 'w-4 h-4 fill-currentColor' }))), 
    // Footer links
    React.createElement('div', { className: 'text-center text-xs text-glorify-text-muted mt-2 font-medium' }, "Don't have an account? ", React.createElement(Link, { to: '/register', className: 'text-glorify-accent hover:underline font-bold outline-none focus-ring pl-0.5' }, 'Sign Up Free'))));
}
