...
import { Play, Sparkles, Heart, Clock, Disc, Music, TrendingUp, Compass, Award, Star, ListMusic } from 'lucide-react';
...
export function Home() {
  ...
  const recentlyPlayedTracks = useMemo(() => {
    if (listeningHistory && listeningHistory.length > 0) {
      ...
      return uniqueIds.map(id => tracks.find(t => t.id === id)).filter(Boolean) as Track[];
    }
  ...
  const becauseYouListenedTracks = useMemo(() => {
    if (!becauseYouListenedTrack) return [];
  ...
  const handleQuickAccessPlay = (e: React.MouseEvent, item: typeof quickAccessItems[0]) => {
    e.stopPropagation();
    if (item.type === 'album') handlePlayAlbum(item.id);
    else if (item.type === 'artist') handlePlayArtist(item.id);
    else if (item.type === 'playlist') handlePlayPlaylist(item.id);
  };
  ...
  return React.createElement(
    'div',
    { className: 'w-full flex flex-col gap-12 mt-4 pb-32 font-sans' },
    ...
    featuredTrack &&
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'flex flex-col gap-3 max-w-md z-10 text-left' },
          React.createElement('span', { className: 'text-[10px] font-bold text-glorify-accent tracking-widest uppercase' }, 'Featured Release'),
          React.createElement('h1', { className: 'text-3xl md:text-5xl font-extrabold tracking-tight text-glorify-text-primary leading-tight' }, featuredTrack.title),
          React.createElement('p', { className: 'text-sm text-glorify-text-secondary font-medium' }, `By ${featuredTrack.artist} • Track of the week`),
          React.createElement(
            'div',
    ...
    React.createElement(
      ...
      React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1' }, `${greeting}`),
      React.createElement(
        'div',
        ...
        quickAccessItems.map((item) =>
          React.createElement(
            ...
            React.createElement(
              'span',
              { className: 'pl-4 text-sm font-semibold text-glorify-text-primary truncate' },
              item.title
            ),
            React.createElement(
              motion.button,
              {
                onClick: (e: any) => handleQuickAccessPlay(e, item),
    ...
    React.createElement(
      ...
      recentlyPlayedTracks.length > 0 &&
        React.createElement(
          motion.div,
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1' }, 'Recently played'),
          React.createElement(
            'div',
            { className: 'flex gap-6 overflow-x-auto scrollbar-none py-2 px-1' },
            recentlyPlayedTracks.map((track) =>
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'w-full aspect-square bg-glorify-bg-secondary/60 rounded-[20px] relative overflow-hidden flex items-center justify-center' },
                  track.coverImage
                    ...
                    : React.createElement(Music, { className: 'w-ch-6 h-ch-6 text-glorify-text-muted/60' }),
                  React.createElement('div', { className: 'absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none' }),
                  React.createElement(
                    motion.button,
                    {
                      onClick: (e: any) => {
                ...
                React.createElement(
                  'div',
                  { className: 'mt-3 text-left px-1' },
                  React.createElement('div', { className: 'text-xs font-semibold text-glorify-text-primary truncate' }, track.title),
                  React.createElement('div', { className: 'text-[10px] text-glorify-text-muted truncate mt-0.5 font-normal' }, track.artist)
                )
              )
            )
          )
      ...
      jumpBackInTracks.length > 0 &&
        React.createElement(
          motion.div,
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1' }, 'Jump back in'),
          React.createElement(
            'div',
            { className: 'flex gap-6 overflow-x-auto scrollbar-none py-2 px-1' },
      ...
      playlists.length > 0 &&
        React.createElement(
          motion.div,
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1' }, 'Made for you'),
          React.createElement(
            'div',
            { className: 'flex gap-6 overflow-x-auto scrollbar-none py-2 px-1' },
            playlists.map((playlist) =>
              React.createElement(
                'div',
                { key: 'madefor-' + playlist.id, className: 'w-48 flex-shrink-0' },
      ...
      becauseYouListenedTrack && becauseYouListenedTracks.length > 0 &&
        React.createElement(
          motion.div,
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1 flex items-center gap-2' }, 
            React.createElement(Sparkles, { className: 'w-5 h-5 text-glorify-accent' }),
            `Because you listened to ${becauseYouListenedTrack.title}`
          ),
          React.createElement(
            'div',
            { className: 'flex gap-6 overflow-x-auto scrollbar-none py-2 px-1' },
            becauseYouListenedTracks.map((track) =>
              React.createElement(
                motion.div,
                {
      ...
      trendingAlbums.length > 0 &&
        React.createElement(
          ...
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1 flex items-center gap-2' }, 
            React.createElement(TrendingUp, { className: 'w-5 h-5 text-glorify-accent' }),
            'Trending'
          ),
          React.createElement(
            'div',
            ...
            trendingAlbums.map((album) =>
              React.createElement(
                'div',
                { key: 'trending-' + album.id, className: 'w-48 flex-shrink-0' },
                React.createElement(CatalogCard, {
                  id: album.id,
                  title: album.title,
      ...
      newReleases.length > 0 &&
        React.createElement(
          ...
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1 flex items-center gap-2' }, 
            React.createElement(Compass, { className: 'w-5 h-5 text-glorify-accent' }),
            'New releases'
          ),
          React.createElement(
            'div',
            ...
            newReleases.map((album) =>
              React.createElement(
                'div',
                { key: 'new-release-' + album.id, className: 'w-48 flex-shrink-0' },
                React.createElement(CatalogCard, {
                  id: album.id,
                  title: album.title,
                  subtitle: album.artistName,
      ...
      chartsTracks.length > 0 &&
        React.createElement(
          ...
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1 flex items-center gap-2' }, 
            React.createElement(Award, { className: 'w-5 h-5 text-glorify-accent' }),
            'Charts'
          ),
          React.createElement(
            'div',
            { className: 'flex gap-6 overflow-x-auto scrollbar-none py-2 px-1' },
            chartsTracks.map((track) =>
              React.createElement(
                motion.div,
                {
                  key: 'chart-' + track.id,
      ...
      artistsYouLike.length > 0 &&
        React.createElement(
          ...
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1 flex items-center gap-2' }, 
            React.createElement(Heart, { className: 'w-5 h-5 text-glorify-accent fill-currentColor' }),
            'Artists you like'
          ),
          React.createElement(
            'div',
            { className: 'flex gap-6 overflow-x-auto scrollbar-none py-2 px-1' },
            artistsYouLike.map((artist) =>
              React.createElement(
                'div',
                { key: 'artist-like-' + artist.id, className: 'w-48 flex-shrink-0' },
                React.createElement(CatalogCard, {
                  id: artist.id,
                  title: artist.name,
      ...
      popularThisWeek.length > 0 &&
        React.createElement(
          ...
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1 flex items-center gap-2' }, 
            React.createElement(Star, { className: 'w-5 h-5 text-glorify-accent' }),
            'Popular this week'
          ),
          React.createElement(
            'div',
            { className: 'flex gap-6 overflow-x-auto scrollbar-none py-2 px-1' },
            popularThisWeek.map((track) =>
              React.createElement(
                motion.div,
                {
      ...
      continueListeningTracks.length > 0 &&
        React.createElement(
          ...
          { variants: itemVariants, className: 'flex flex-col gap-4' },
          React.createElement('h2', { className: 'text-2xl font-extrabold tracking-tight text-glorify-text-primary pl-1 flex items-center gap-2' }, 
            React.createElement(Clock, { className: 'w-5 h-5 text-glorify-accent' }),
            'Continue listening'
          ),
          React.createElement(
            'div',
