...
type LibraryTab = 'songs' | 'albums' | 'artists' | 'playlists' | 'liked' | 'downloads';
type SortCriteria = 'alphabetical' | 'recently_added' | 'creator' | 'duration';
...
export function Library() {
  ...
  const processedAlbums = useMemo(() => {
    ...
    if (sortBy === 'alphabetical') result.sort((a, b) => a.title.localeCompare(b.title));
    else if (sortBy === 'creator') result.sort((a, b) => a.artistName.localeCompare(b.artistName));
    return result;
