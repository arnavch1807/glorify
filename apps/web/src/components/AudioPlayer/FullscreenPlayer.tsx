...
export function FullscreenPlayer() {
  ...
  const activeColors = useMemo(() => {
    if (!currentTrack) return { accent: '#D4AF37', glow: 'rgba(212, 175, 55, 0.35)' };
    ...
    isFullscreen && currentTrack &&
      React.createElement(
        motion.div,
        {
          ...
          className:
            'fixed inset-0 z-[9999] bg-glorify-bg-primary text-glorify-text-primary flex flex-col justify-between font-sans selection:bg-transparent overflow-hidden w-screen h-screen',
        },
        ...
        React.createElement(
          ...
          {
            className:
              'w-full h-20 px-8 flex items-center justify-between z-20 relative bg-glorify-bg-primary/10 backdrop-blur-md',
          },
          React.createElement(
            'span',
            { className: 'text-xs font-bold tracking-widest uppercase text-glorify-accent/80' },
            'Glorify Premium'
          ),
          ...
          React.createElement(
            'div',
            { className: 'flex items-center gap-ch-3 text-xs font-medium bg-glorify-bg-secondary/60 border border-glorify-border-primary/10 p-1 rounded-full' },
            [
              ...
              React.createElement(
                'button',
                {
                  ...
                  className: `flex items-center gap-ch-1.5 px-ch-4 py-1.5 rounded-full transition-all cursor-pointer outline-none ${
          ...
          React.createElement(
            motion.button,
            {
              ...
              whileTap: { scale: 0.9 },
              className:
                'p-2 rounded-full hover:bg-white/10 cursor-pointer outline-none focus-ring text-glorify-text-secondary hover:text-glorify-copper transition-colors',
        ...
        React.createElement(
          'div',
          { className: 'flex-1 overflow-hidden z-10 relative flex items-center justify-center p-8 w-full max-w-[1100px] mx-auto' },
          
          // PLAYBACK VIEW (Fully Centered Single Column Layout)
          activePlayerTab === 'playback' &&
            React.createElement(
              'div',
              { className: 'flex flex-col items-center justify-center gap-8 w-full max-w-[500px] mx-auto text-center font-sans' },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    currentTrack.coverImage
                      ...
                      : React.createElement(Disc, { key: 'fallback-disc', className: 'w-20 h-20 text-glorify-text-muted animate-spin-slow' })
                  )
                ),
                currentTrack.coverImage &&
              ...
              React.createElement(
                'div',
                { className: 'flex flex-col gap-1.5 mt-2 h-16 justify-center overflow-hidden relative w-full' },
                React.createElement(
                  AnimatePresence,
                  { mode: 'wait' },
                  React.createElement(
                    ...
                    React.createElement(
                      'h2',
                      { className: 'text-2xl md:text-3xl font-extrabold tracking-tight text-glorify-text-primary truncate px-2' },
                      currentTrack.title
                    ),
                    React.createElement(
                      'p',
                      { className: 'text-base text-glorify-text-muted font-medium truncate px-2' },
                      currentTrack.artist
                    )
                  )
                )
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'w-full flex items-center justify-between text-xs font-bold px-1 mb-2 text-glorify-text-secondary' },
                  React.createElement('span', null, formatDuration(displayTime)),
                  isScrubbing && React.createElement(
                    'span',
                    { className: 'text-[9px] font-bold text-glorify-accent bg-glorify-accent-glow px-2 py-0.5 rounded-full shadow-sm animate-pulse' },
                    'Dragging'
                  ),
                  React.createElement('span', null, `-${formatDuration(remainingTime)}`)
                ),
                React.createElement(
                  'div',
              ...
              React.createElement(
                'div',
                { className: 'flex items-center justify-center gap-6 md:gap-8 my-2' },
                ...
                React.createElement(motion.button, {
                  ...
                  className: `p-2 rounded-full cursor-pointer relative transition-all ${
                    repeatMode !== 'none' ? 'text-glorify-accent' : 'text-glorify-text-muted hover:text-glorify-copper'
                  }`,
                  title: 'Repeat'
                }, React.createElement(Repeat, { className: 'w-5 h-5' }),
                   repeatMode !== 'none' && React.createElement('span', { className: 'absolute bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full bg-glorify-accent' })
                )
              ),
              ...
              React.createElement(
                'div',
                { className: 'w-full flex items-center justify-between mt-4 gap-6' },
                ...
                React.createElement(motion.button, {
                  ...
                  className: `p-2 rounded-full cursor-pointer transition-all ${
                    isLiked ? 'text-glorify-accent' : 'text-glorify-text-secondary hover:text-glorify-copper'
                  }`,
                ...
                React.createElement(
                  'div',
                  { className: 'flex-1 max-w-[220px] flex items-center gap-3 bg-glorify-bg-secondary/40 border border-glorify-border-primary/5 px-4 py-2 rounded-full shadow-sm hover:shadow-md transition-all hover:scale-[1.02]' },
                  React.createElement(
                    motion.button,
                    {
                      onClick: toggleMute,
          ...
          React.createElement(
            ...
            activePlayerTab === 'queue' &&
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'flex items-center justify-between pb-ch-3 border-b border-glorify-border-primary/5' },
                  React.createElement('span', { className: 'text-sm font-semibold text-glorify-text-primary' }, 'Queue'),
                  queue.length > 1 &&
                    React.createElement(
                      'button',
                      {
                ...
                React.createElement(
                  'div',
                  { className: 'flex-1 overflow-y-auto flex flex-col gap-ch-1.5 scrollbar-none justify-center' },
                  queue.length === 0
                    ...
                    return React.createElement(
                      'div',
                      {
                        ...
                        className: `flex items-center gap-ch-3 p-ch-3 rounded-[12px] text-left text-sm transition-colors group cursor-grab active:cursor-grabbing border border-transparent ${
                          isPlayingTrack
                      ...
                      React.createElement(
                        'span',
                        { className: 'w-ch-4 text-xs font-mono text-glorify-text-muted/50' },
                        String(idx + 1).padStart(2, '0')
                      ),
                      track.coverImage && React.createElement('img', { src: track.coverImage, alt: '', className: 'w-8 h-8 rounded object-cover' }),
                      React.createElement(
                        'div',
                        { className: 'flex-1 min-w-0' },
                        React.createElement('div', { className: 'text-xs font-medium truncate' }, track.title),
                        React.createElement('div', { className: 'text-[10px] text-glorify-text-muted truncate mt-0.5' }, track.artist)
                      ),
                      isPlayingTrack
          ...
          React.createElement(
            ...
            activePlayerTab === 'settings' &&
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'flex items-center gap-ch-2 pb-ch-3 text-glorify-accent border-b border-glorify-border-primary/5' },
                  React.createElement(Sliders, { className: 'w-ch-4.5 h-ch-4.5' }),
                  React.createElement('span', { className: 'text-sm font-semibold' }, 'Premium Audio Tuning')
                ),
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement('span', { className: 'text-glorify-text-primary' }, `${crossfadeDuration}s`)
                  ),
                  React.createElement('input', {
                    type: 'range',
                    min: 0,
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(Moon, { className: 'w-ch-4 h-ch-4 text-glorify-text-muted' }),
                      'Sleep Timer'
                    ),
                    React.createElement('span', { className: 'text-glorify-accent' }, sleepTimerMinutes ? `${sleepTimerMinutes}m` : 'Off')
                  ),
                  React.createElement(
                    'div',
                    ...
                    [null, 5, 15, 30].map((min) =>
                      React.createElement(
                        'button',
                        {
                          ...
                          className: `py-2 rounded-full border border-glorify-border-primary/10 text-xs font-semibold cursor-pointer outline-none transition-all ${
                ...
                React.createElement(
                  ...
                  React.createElement('label', { className: 'text-xs text-glorify-text-secondary font-medium' }, 'Output Source Device'),
                ...
                React.createElement(
                  'div',
                  { className: 'flex flex-col gap-ch-4 pt-ch-4 border-t border-glorify-border-primary/5' },
                  [
                    ...
                    React.createElement(
                      ...
                      React.createElement('span', { className: 'text-xs text-glorify-text-secondary font-medium' }, sw.label),
                      React.createElement('input', {
                        type: 'checkbox',
                        checked: sw.val,
                        onChange: sw.toggle,
