...
export function TrackContextMenu({ track, x, y, triggerRect, onClose, onGoToAlbum, onGoToArtist, }) {
    ...
    return createPortal(React.createElement(React.Fragment, null, React.createElement('div', {
        ...
        className: 'fixed z-[99999] min-w-44 bg-glorify-bg-surface border border-glorify-border-primary rounded-xl shadow-[0_15px_35px_rgba(0,0,0,0.4)] py-1.5 flex flex-col text-xs font-sans select-none pointer-events-auto backdrop-blur-md',
        ...
        className: 'w-full text-left px-ch-4 py-ch-2 hover:bg-glorify-bg-secondary text-glorify-text-primary flex items-center gap-ch-2.5 cursor-pointer outline-none',
    }, React.createElement(Plus, { className: 'w-ch-3.5 h-ch-3.5 text-glorify-text-muted' }), 'Add to Queue'), React.createElement('button', {
        onClick: () => setShowAddToPlaylistModal(true),
        className: 'w-full text-left px-ch-4 py-ch-2 hover:bg-glorify-bg-secondary text-glorify-text-primary flex items-center gap-ch-2.5 cursor-pointer outline-none',
    }, React.createElement(ListPlus, { className: 'w-ch-3.5 h-ch-3.5 text-glorify-text-muted' }), 'Add to Playlist'), track.album &&
        React.createElement('button', {
    ...
    }, React.createElement(Info, { className: 'w-ch-3.5 h-ch-3.5 text-glorify-text-muted' }), 'Track Info'), track.source === 'local' &&
        React.createElement('button', {
            onClick: () => setShowMetadataModal(true),
            className: 'w-full text-left px-ch-4 py-ch-2 hover:bg-glorify-bg-secondary text-glorify-text-primary flex items-center gap-ch-2.5 cursor-pointer outline-none border-t border-glorify-border-primary/50 mt-1',
        }, React.createElement(Pencil, { className: 'w-ch-3.5 h-ch-3.5 text-glorify-text-muted' }), 'Edit Metadata'), track.source === 'local' &&
        React.createElement('button', {
            onClick: () => setShowLyricsModal(true),
            className: 'w-full text-left px-ch-4 py-ch-2 hover:bg-glorify-bg-secondary text-glorify-text-primary flex items-center gap-ch-2.5 cursor-pointer outline-none border-t border-glorify-border-primary/50 mt-1',
        }, React.createElement(AlignLeft, { className: 'w-ch-3.5 h-ch-3.5 text-glorify-text-muted' }), 'Edit Lyrics')), 
