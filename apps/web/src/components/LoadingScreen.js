...
export function LoadingScreen() {
    return React.createElement('div', { className: 'w-full py-16 flex flex-col items-center justify-center min-h-[40vh] select-none text-center font-sans' }, 
    // Core GLORIFY container with gold accents and slow glowing pulse
    React.createElement('div', { className: 'flex flex-col items-center gap-ch-4' }, React.createElement(motion.div, {
        animate: {
